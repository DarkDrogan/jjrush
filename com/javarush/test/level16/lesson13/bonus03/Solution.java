...
public class Solution {
    ...
    public static class TestedThread extends Thread {
        public TestedThread(UncaughtExceptionHandler handler) {
            //можно решить задачу сделав здесь setDefaultUncaughtExceptionHandler(handler);
            //setUncaughtExceptionHandler(handler); - это было вот так, в методе Run() закоментирован второй вариант

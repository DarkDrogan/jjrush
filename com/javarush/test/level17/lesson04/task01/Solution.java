...
блокировали мютекс notes, не this
2. Все System.out.println не должны быть заблокированы (синхронизированы), т.е. не должны находиться
...
public class Solution {
    public static class Note {
        ...
        public void removeNote(int index) {
            ...
            System.out.println("Уже удалена заметка [" + notes.get(index) + "] с позиции " + index);
        }
    }
}